...
// creating wizards (called in Generator.js)
  ...
  addPercentWiz = () => {
    ...
    let newWizard = JSON.parse(`{ "name": "PercentWizard${perWizLength}", "prompt": "Set this text in the wizard", "rate": "" }`);
  ...
  addDollarWiz = () => {
    ...
    let newWizard = JSON.parse(`{ "name": "DollarWizard${perWizLength}", "prompt": "Set this text in the wizard", "dollar": "" }`);
